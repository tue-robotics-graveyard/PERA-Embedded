...
#define ESCREG_TIMEDIFFERENCE   0x092C
...
#define FOE_DATA_SIZE   (MBXSIZE - (MBXHSIZE+FOEHSIZE))
...
extern uint8_t           SDO1C12size;
extern uint8_t           SDO1C13size;
