...
#define DIGITAL_INPUTS          0x17
#define DIGITAL_OUTPUTS         0x05
...
{{0x00,DTYPE_UNSIGNED8,8,ATYPE_R,&acNameNOE[0],DIGITAL_INPUTS},
  {0x01,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60000110},
  ...
  {0x05,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60000508},
  ...
  {0x0b,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60000b20},
  {0x0c,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60000c20},
  {0x0d,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60000d20},
  {0x0e,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60000e20},
  {0x0f,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60000f20},
  {0x10,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60001020},
  {0x11,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60001120},
  {0x12,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60001220},
  {0x13,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60001320},
  {0x14,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60001420},
  {0x15,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60001520},
  {0x16,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60001620},
  {0x17,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0],0x60001710}
};

_objd SDO6000[]=
{{0x00,DTYPE_UNSIGNED8  ,8,ATYPE_R,&acNameNOE[0],DIGITAL_INPUTS},
  {0x01,DTYPE_UNSIGNED16 ,16,ATYPE_R,&acName6000_01[0],0,&(Rb.status)   },
  {0x02,DTYPE_UNSIGNED16 ,32,ATYPE_R,&acName6000_02[0],0,&(Rb.enc_position[0]) },
  {0x03,DTYPE_UNSIGNED16 ,32,ATYPE_R,&acName6000_03[0],0,&(Rb.enc_position[1]) },
  {0x04,DTYPE_UNSIGNED16 ,32,ATYPE_R,&acName6000_04[0],0,&(Rb.enc_position[2]) },
  {0x05,DTYPE_UNSIGNED8  , 8,ATYPE_R,&acName6000_05[0],0,&(Rb.spare_in)     },
  {0x06,DTYPE_REAL32     ,32,ATYPE_R,&acName6001_01[0],0,&(Rb.ADC[0])  },
  {0x07,DTYPE_REAL32     ,32,ATYPE_R,&acName6001_02[0],0,&(Rb.ADC[1])  },
  {0x08,DTYPE_REAL32     ,32,ATYPE_R,&acName6001_03[0],0,&(Rb.ADC[2])  },
  {0x09,DTYPE_REAL32     ,32,ATYPE_R,&acName6001_04[0],0,&(Rb.ADC[3])  },
  {0x0a,DTYPE_REAL32     ,32,ATYPE_R,&acName6001_05[0],0,&(Rb.ADC[4])  },
  {0x0b,DTYPE_REAL32     ,32,ATYPE_R,&acName6001_06[0],0,&(Rb.ADC[5])  },
  {0x0c,DTYPE_REAL32     ,32,ATYPE_R,&acName6001_07[0],0,&(Rb.ADC[6])  },
  {0x0d,DTYPE_REAL32     ,32,ATYPE_R,&acName6001_08[0],0,&(Rb.ADC[7])  },
  {0x0e,DTYPE_REAL32     ,32,ATYPE_R,&acName6002_01[0],0,&(Rb.ADC[8])  },
  {0x0f,DTYPE_REAL32     ,32,ATYPE_R,&acName6002_02[0],0,&(Rb.ADC[9])  },
  {0x10,DTYPE_REAL32     ,32,ATYPE_R,&acName6002_03[0],0,&(Rb.ADC[10]) },
  {0x11,DTYPE_REAL32     ,32,ATYPE_R,&acName6002_04[0],0,&(Rb.ADC[11]) },
  {0x12,DTYPE_REAL32     ,32,ATYPE_R,&acName6002_05[0],0,&(Rb.ADC[12]) },
  {0x13,DTYPE_REAL32     ,32,ATYPE_R,&acName6002_06[0],0,&(Rb.ADC[13]) },
  {0x14,DTYPE_REAL32     ,32,ATYPE_R,&acName6002_07[0],0,&(Rb.ADC[14]) },
  {0x15,DTYPE_REAL32     ,32,ATYPE_R,&acName6002_08[0],0,&(Rb.ADC[15]) },
  {0x16,DTYPE_UNSIGNED32 ,32,ATYPE_R,&acName6003_01[0],0,&(Rb.msg_idx) },
  {0x17,DTYPE_UNSIGNED16 ,16,ATYPE_R,&acName6003_02[0],0,&(Rb.actuator_id) }
...
{{0x00,DTYPE_UNSIGNED8  ,8,ATYPE_R,&acNameNOE[0],DIGITAL_OUTPUTS},
  ...
  {0x04,DTYPE_UNSIGNED8 , 8,ATYPE_RW,&acName7000_04[0],0,&(Wb.spare_out)},
