...
#define DIGITAL_INPUTS          0x0E
#define DIGITAL_OUTPUTS         0x08
...
_ac acName6001_07[]="current_1";
_ac acName6001_08[]="current_2";
_ac acName6001_09[]="current_3";
_ac acName6001_10[]="spare_analog_in_1";
_ac acName6001_11[]="spare_analog_in_2";
...
_ac acName7000_04[]="dac_1";
_ac acName7000_05[]="dac_2";
//_ac acName7000_04[]="spare_digital_out";
_ac acName7000_06[]="control_register";
_ac acName7000_07[]="heart_beat";
_ac acName7000_08[]="disable_motor_register";
...
_objd SDO1A00[]={
  ...
  {0x0e,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0] ,0x60000e08}
};

_objd SDO6000[]={
  {0x00,DTYPE_UNSIGNED8 , 8,ATYPE_R,&acNameNOE[0]    ,DIGITAL_INPUTS},
  {0x01,DTYPE_UNSIGNED8 , 8,ATYPE_R,&acName6000_01[0],0,&(Rb.status_register)},
  {0x02,DTYPE_UNSIGNED16,16,ATYPE_R,&acName6000_02[0],0,&(Rb.enc_position_1)},
  {0x03,DTYPE_UNSIGNED16,16,ATYPE_R,&acName6000_03[0],0,&(Rb.enc_position_2)},
  {0x04,DTYPE_UNSIGNED16,16,ATYPE_R,&acName6000_04[0],0,&(Rb.enc_position_3)},
  ...
  {0x0b,DTYPE_UNSIGNED16,16,ATYPE_R,&acName6001_07[0],0,&(Rb.ADC[6])},
  {0x0c,DTYPE_UNSIGNED16,16,ATYPE_R,&acName6001_08[0],0,&(Rb.ADC[7])},
  {0x0d,DTYPE_UNSIGNED16,16,ATYPE_R,&acName6001_09[0],0,&(Rb.ADC[8])},
  {0x0e,DTYPE_UNSIGNED8 , 8,ATYPE_R,&acName6003_01[0],0,&(Rb.msg_idx)}
};
...
_objd SDO1600[]={
  ...
  {0x07,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0] ,0x70000708},
  {0x08,DTYPE_UNSIGNED32,32,ATYPE_R,&acNameMO[0] ,0x70000808}
};
...
_objd SDO7000[]={
  ...
  {0x04,DTYPE_INTEGER16 ,16,ATYPE_RW,&acName7000_04[0],0,&(Wb.dac[0])},
  {0x05,DTYPE_INTEGER16 ,16,ATYPE_RW,&acName7000_05[0],0,&(Wb.dac[1])},
  {0x06,DTYPE_UNSIGNED8 , 8,ATYPE_RW,&acName7000_06[0],0,&(Wb.control_register)},
  {0x07,DTYPE_UNSIGNED8 , 8,ATYPE_RW,&acName7000_07[0],0,&(Wb.heart_beat)},
  {0x08,DTYPE_UNSIGNED8 , 8,ATYPE_RW,&acName7000_08[0],0,&(Wb.disable_motor_register)}
};
